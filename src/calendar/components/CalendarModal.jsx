...
// Esto sirve para seleccionar el elemento HMTL sobre el que vamos a desplegar el modal
...
export const CalendarModal = () => {
  ...
  // Linea para cambiar el estilo de los input
  ...
  const onSubmitEvent = async(event) =>{
    ...
    if( isNaN( differents ) || differents <= 0 ){
      console.log('Error en validacion de fechas');
      Swal.fire('Fechas incorrectas', 'Revisar las fechas ingresadas', 'error')
      return;
    }

    if( formValues.title.length === 0 ){
      Swal.fire('Titulo incorrecto', 'Favor de revisar el titulo dado', 'error')
      return;
    }
